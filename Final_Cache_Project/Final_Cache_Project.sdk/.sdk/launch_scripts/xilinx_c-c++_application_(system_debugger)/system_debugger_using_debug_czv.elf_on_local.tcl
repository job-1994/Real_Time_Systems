...
ps7_init
ps7_post_config
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Zybo 210279771777A"} -index 0
rst -processor
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Zybo 210279771777A"} -index 0
dow /home/job/Documents/Real_Time_Systems/Final_Cache_Project/Final_Cache_Project.sdk/czv/Debug/czv.elf
